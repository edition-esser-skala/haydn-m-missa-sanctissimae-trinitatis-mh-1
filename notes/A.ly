...
AgnusAlto = {
  \relative c' {
    ...
    e2 a8( b4) a8
    a4( gis) a r8 a %35
    cis,4 cis8 d g4 g8 f
    e4 e8 d g4 h \noBreak
    a2 a\fermata \bar "||"
    \key d \major \tempoDona R1*4 %42
    \mvTr a4.\fE^\tutti cis8 h4 e
